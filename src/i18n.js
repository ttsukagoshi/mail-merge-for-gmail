...
const MESSAGES = {
  'en': {
    ...
    'cardEnterCc': 'CC',
    'cardHintCc': '[Optional] CC recipients\' email address.',
    'cardEnterBcc': 'BCC',
    'cardHintBcc': '[Optional] BCC recipients\' email address.',
    ...
    'errorNoToEntered': '[Mail Merge Error]\nNo To recipients entered. Make sure you have entered email address(es).',
