...
const MESSAGES = {
  'en': {
    'cardMessage': 'Mail Merge for Gmail: Send personalized emails based on Gmail template to multiple recipients. Together with an optional <b>Group Merge</b> feature.\n\nEnter the following items and select <b><i>Create Drafts</i></b> or <b><i>Send Emails</i></b>. <b>All items are required fields</b> unless otherwise noted.',
  ...
  'ja': {
    ...
    'errorMailMergeCanceled': '[Mail Merge Error]\nメール差込が中断されました。',
